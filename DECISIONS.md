...
| **Date-effective pricing**: each turn priced at the rate in effect when it ran (`rates:` periods, inclusive UTC `until`) | One flat number cannot serve both historical and future turns across a rate change (Sonnet 5 cliff 2026-09-01) | v1.8.0 changelog |
